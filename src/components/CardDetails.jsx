...
const toRemove = ["HD","MTV","Audio","%20", ".mp3", "%5", "%80", "with","With","lyrics","Lyrics",".(Official Video)", "%E2", "Official", "official", "%99", "%C3", "%F0", "%9F", "%8E", "%A7","v1","version","MusicVideo","Video",""];
...
const cleanSongName = (name) => {
  ...
  if (cleanedName) {
    ...
    return ""; // Return empty string if cleanedName is undefined
  }
};
